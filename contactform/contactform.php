...
$contact_email_to = "hello@mena-markets.com";
...
// Country invalid error text
$contact_error_country = "Please choose your country!";
...
if(isset($_POST)) {
  ...
  $send ="Name: ".$name ."\n\n Telephone: ".$telephone."\n\n Email: " .$email. "\n\n Country: ".$country . "\n\n Message: ".$message;
  $sendemail = mail($contact_email_to, $contact_subject_prefix . "Mena Market Landing Page", $send,
